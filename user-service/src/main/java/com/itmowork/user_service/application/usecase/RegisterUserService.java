    ...
    public Mono<AuthResult> register(RegisterUserCommand command) {
        ...
        return userRepositoryPort.findByEmail(email)
                ...
                .flatMap(exists -> {
                    ...
                    return roleRepositoryPort.findByRoleName(RoleName.ROLE_USER)
                            .switchIfEmpty(Mono.error(new RoleNotFoundException("Default role ROLE_USER not found")))
                            .flatMap(defaultRole -> {
                                ...
                                return userRepositoryPort.save(newUser)
                                        .flatMap(saved -> {
                                            ...
                                            return tokenGeneratorPort
                                                    .generateAccessToken(saved.getId(), saved.getEmail(), roles)
