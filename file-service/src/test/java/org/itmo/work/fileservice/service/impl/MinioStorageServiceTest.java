...
//        service = new MinioStorageService(internalClient, presignClient, minioProperties);
//    }
//
//    @Test
...
//        verify(internalClient, times(1)).putObject(captor.capture());
//
...
//        verify(internalClient, times(1)).removeObject(captor.capture());
//
...
//
//        assertEquals("Minio delete failed", ex.getMessage());
//        assertNotNull(ex.getCause());
//        assertEquals("boom", ex.getCause().getMessage());
//    }
//
